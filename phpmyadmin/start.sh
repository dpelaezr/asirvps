...
newUser(){
    ...
    echo "MAQ2-->passwordBD-->${PASSWORD}" >> /root/datos.txt
...
config_Mysql(){
    ...
    echo "CREATE USER '${USUARIO}'@'190.180.170.20' IDENTIFIED BY '${PASSWD}';" > /root/user.sql
    echo "GRANT ALL PRIVILEGES ON *.* TO '${USUARIO}'@'190.180.170.20';" >> /root/user.sql
